(function($) {
 ...
 var dzChartlist = function(){
	var pending = document.getElementById("pending_id").textContent;
	var recovered = document.getElementById("recoverd_id").textContent;
	var treatment = document.getElementById("treatment_id").textContent;
	let draw = Chart.controllers.line.__super__.draw; //draw shadow
	var screenWidth = $(window).width();
	var radialBar = function(){
		var options = {
      series: [pending, recovered, treatment],
      chart: {
        height: 330,
        type: "radialBar",
      },
